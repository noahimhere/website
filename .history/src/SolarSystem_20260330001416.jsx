...
const wireSphereGeometry = new WireframeGeometry(sphereGeometry)

const planets = [
  { radius: 0.22, a: 2.5, e: 0.05, inclination: 0.1, speed: 1.4, phase: 0, color: '#7dd3fc' },
  { radius: 0.3, a: 4, e: 0.18, inclination: 0.35, speed: 0.9, phase: 1.2, color: '#fca5a5' },
  { radius: 0.4, a: 5.8, e: 0.1, inclination: -0.2, speed: 0.6, phase: 2.4, color: '#fde68a' },
]
