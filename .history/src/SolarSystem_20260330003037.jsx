...
const planets = [
  ...
  { radius: 0.3, a: 105, e: 0.9, inclination: 0.1, orbitRotation: 2, speed: 0.5, phase: 0, color: '#7dd3fc' }
]
...
function solveEccentricAnomaly(meanAnomaly, eccentricity, iterations = 5) { // super fast speed brrooom when high eccentricity
