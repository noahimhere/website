...
const planets = [
  { radius: 0.34, a: 15, e: 0.05, inclination: 0.1, orbitRotation: 0.2, speed: 0.2, phase: 0, color: '#7dd3fc' },
  { radius: 0.6, a: 40, e: 0.5, inclination: 0.35, orbitRotation: 1.1, speed: 0.1, phase: 1.2, color: '#fca5a5' },
  { radius: 0.4, a: 65.8, e: 0.1, inclination: -0.2, orbitRotation: 2.2, speed: 0.07, phase: 2.4, color: '#fde68a' },
  { radius: 0.8, a: 55.8, e: 0.1, inclination: 0.5, orbitRotation: -0.7, speed: 0.02, phase: 5.4, color: '#4ec246' },
  { radius: 0.3, a: 60, e: 0.9, inclination: 0.1, orbitRotation: 2, speed: 0.09, phase: 0, color: '#7dd3fc' }
]

const CAMERA_DISTANCE_MULTIPLIER = 100 //changes distance of planet from camera
...
function SolarSystem() {
  ...
  return (
    <>
      ...
      />
      <group ref={sunRef}>
        <WireSphere radius={selectedIndex === 0 ? 3.3 : 3} color="#FFFF00" />
      </group>
